            ...
            <el-row>
              <el-col :span="14">
                ...
                >
                  <!--老手机号-->
                  <el-form-item
                    :label="$t('m.userCenter.oldPhone')"
                    prop="oldphone"
                    v-show="oldPhone != 'undefined'"
                  >
                    <el-input
                      :disabled="true"
                      v-model="formatMobile"
                    ></el-input>
                  </el-form-item>
                  <!--老验证码-->
                  <el-form-item
                    :label="$t('m.userCenter.SMSVerificationCode')"
                    :error="errors.oldValidateCode"
                    prop="oldValidateCode"
                  >
                    <el-col :span="14">
                      <el-input
                        :placeholder="$t('m.userCenter.pleasePhoneV')"
                  ...
                  >
                    ...
                    <el-input
                      :placeholder="$t('m.userCenter.plzPhoneNumber')"
                      v-model="ruleForm.newMobilePhone"
                    >
                      <el-select
                      ...
                      >
                        <el-option
                          v-for="(item, key) in countryCodeMap.options"
                          :key="key"
                          :label="item.name"
                          :value="item.code"
                        >
                  ...
                  >
                    ...
                    <el-col :span="9">
                      <validateCode
                        :mobile="ruleForm.newMobilePhone"
  ...
  data() {
    return {
      ...
      rules: {
        ...
        // ],
        newMobilePhone: [{ validator: this.checkMobile, trigger: "blur" }],
        oldValidateCode: [
