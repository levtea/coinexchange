...
public class WorkIssueController {
  ...
  @Autowired private WorkIssueService workIssueService;
  ...
  public R<Page<WorkIssue>> findByPage(
      @ApiIgnore Page<WorkIssue> page, Integer status, String startTime, String endTime) {
  ...
  @ApiImplicitParams({@ApiImplicitParam(name = "workIssue", value = "workIssue的json,只包含questions")})
