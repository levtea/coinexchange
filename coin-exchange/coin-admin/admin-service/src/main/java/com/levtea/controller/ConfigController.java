...
public class ConfigController {
  ...
  public R<Page<Config>> findByPage(
      @ApiIgnore Page<Config> page, String type, String code, String name) {
  ...
  @ApiImplicitParams({@ApiImplicitParam(name = "config", value = "config 的json数据")})
