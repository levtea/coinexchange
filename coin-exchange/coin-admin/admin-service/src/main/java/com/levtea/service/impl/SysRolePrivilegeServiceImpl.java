...
import com.levtea.mapper.SysRolePrivilegeMapper;
...
import com.levtea.service.SysRolePrivilegeService;
...
@Service
public class SysRolePrivilegeServiceImpl
    extends ServiceImpl<SysRolePrivilegeMapper, SysRolePrivilege>
  ...
  @Autowired private SysRolePrivilegeService sysRolePrivilegeService;
  ...
  public List<SysMenu> findSysMenuAndPrivileges(Long roleId) {
    ...
    List<SysMenu> rootMenus =
        list.stream().filter(sysMenu -> sysMenu.getParentId() == null).collect(Collectors.toList());
