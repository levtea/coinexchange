...
public class NoticeController {
  ...
  @ApiImplicitParams({@ApiImplicitParam(name = "ids", value = "要删除的id的集合")})
  ...
  @ApiImplicitParams({@ApiImplicitParam(name = "notice", value = "notice的json数据")})
  ...
  @ApiImplicitParams({@ApiImplicitParam(name = "id", value = "notice的id")})
