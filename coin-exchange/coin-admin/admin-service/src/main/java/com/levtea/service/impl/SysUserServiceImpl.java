...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser>
  ...
  public boolean addUser(SysUser sysUser) {
    ...
    return saveUserRole(sysUser, role_strings, save);
  }
  ...
  public boolean updateUser(SysUser sysUser) {
    ...
    sysUserRoleService.remove(
        new LambdaQueryWrapper<SysUserRole>().in(SysUserRole::getUserId, sysUser.getId()));
    return saveUserRole(sysUser, role_strings, save);
  }

  private boolean saveUserRole(SysUser sysUser, String role_strings, boolean save) {
    if (save) {
