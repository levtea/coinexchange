...
public class WebConfigController {
  ...
  @Autowired private WebConfigService webConfigService;
  ...
  @ApiImplicitParams({@ApiImplicitParam(name = "webConfig", value = "webConfig 的json数据")})
  ...
  @ApiImplicitParams({@ApiImplicitParam(name = "ids", value = "要删除的数据的ids")})
