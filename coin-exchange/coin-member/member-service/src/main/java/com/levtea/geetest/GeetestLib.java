 ...
 *
 * <p>Copyright 2020 GEETEST, Inc. All rights reserved. GEETEST PROPRIETARY/CONFIDENTIAL. Use is
 * subject to license terms.
 */
package com.levtea.geetest;
...
public class GeetestLib {
  ...
  private String requestRegister(Map<String, String> paramMap) {
    ...
    this.gtlog(
        String.format(
            "requestRegister(): 验证初始化, 向极验发送请求, url=%s, params=%s.", register_url, paramMap));
  ...
  /** 正常流程下（即验证初始化成功），二次验证 */
  public GeetestLibResult successValidate(
      String challenge, String validate, String seccode, Map<String, String> paramMap) {
    this.gtlog(
        String.format(
  ...
  private String requestValidate(
    ...
    this.gtlog(
        String.format(
            "requestValidate(): 二次验证 正常模式, 向极验发送请求, url=%s, params=%s.", validate_url, paramMap));
  ...
  private boolean checkParam(String challenge, String validate, String seccode) {
    return !(challenge == null
        ...
        || validate == null
        || validate.trim().isEmpty()
        || seccode == null
        || seccode.trim().isEmpty());
  }
