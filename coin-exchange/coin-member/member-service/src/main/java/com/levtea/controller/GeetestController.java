...
import com.levtea.geetest.GeetestLibResult;
import com.levtea.model.R;
import com.levtea.util.IpUtil;
...
public class GeetestController {
  ...
  @ApiImplicitParams({@ApiImplicitParam(name = "uuid", value = "用户验证的一个凭证")})
  public R<String> register(String uuid) {
    ...
    redisTemplate
        .opsForValue()
        .set(
            GeetestLib.GEETEST_SERVER_STATUS_SESSION_KEY,
            result.getStatus(),
            180,
            TimeUnit.SECONDS);
    ...
    redisTemplate
        .opsForValue()
        .set(GeetestLib.GEETEST_SERVER_USER_KEY + ":" + uuid, uuid, 180, TimeUnit.SECONDS);
