...
import com.levtea.service.LoginService;
...
public class LoginServiceImpl implements LoginService {
  ...
  public LoginUser login(LoginForm loginForm) {
    ...
    if (tokenResponseEntity.getStatusCode() == HttpStatus.OK) {
      ...
      strRedisTemplate
          .opsForValue()
          .set(jwtToken.getAccessToken(), "", jwtToken.getExpiresIn(), TimeUnit.SECONDS);
    }
    return loginUser;
  }
