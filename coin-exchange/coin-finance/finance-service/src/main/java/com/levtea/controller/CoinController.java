...
public class CoinController {
  ...
  @ApiImplicitParams({@ApiImplicitParam(name = "coin", value = "coin的json数据")})
  ...
  @ApiImplicitParams({@ApiImplicitParam(name = "id", value = "币种的id")})
  ...
  @GetMapping("/all")
  @ApiImplicitParams({@ApiImplicitParam(name = "status", value = "币种当前的状态")})
