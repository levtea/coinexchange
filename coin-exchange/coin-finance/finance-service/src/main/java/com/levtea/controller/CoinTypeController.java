...
public class CoinTypeController {
  ...
  @Autowired private CoinTypeService coinTypeService;
  ...
  @ApiImplicitParams({@ApiImplicitParam(name = "coinType", value = "coinType 的json")})
  ...
  @ApiImplicitParams({@ApiImplicitParam(name = "status", value = "币种的状态")})
  @PreAuthorize("hasAuthority('trade_coin_type_query')")
